...
const insertOne = async (parameters) => {
  ...
  const query = 'INSERT INTO reviewsdb.reviews_by_listing (listing_id,review_id,accuracy,avatar_url,check_in,cleanliness,communication,created_at,email,location,name,text,user_id,username,value) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?);';
